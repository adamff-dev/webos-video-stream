...
- Use [Device Manager app](https://github.com/webosbrew/dev-manager-desktop) - see [Releases](https://github.com/adamff-dev/browser-webos/releases) for a
...
```sh
luna-send-pub -n 1 'luna://com.webos.service.eim/addDevice' '{"appId":"rvp.adamffdev.v1","pigImage":"","mvpdIcon":""}'
```
...
```sh
luna-send-pub -n 1 'luna://com.webos.service.eim/deleteDevice' '{"appId":"rvp.adamffdev.v1"}'
```
...
```sh
git clone https://github.com/adamff-dev/browser-webos.git
```
